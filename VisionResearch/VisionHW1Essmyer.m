...
% to create similarity matrix => medel_histogram
...
% storing the distances from the test histogam to the different categories
% in the model
for i=1:10
    dist(i) = pdist2(test_histogram, model_histogram(i,:));
end
%table of min distances for the 10 category
[Y,I] = min(dist);
